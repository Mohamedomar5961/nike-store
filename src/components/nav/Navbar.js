...
const Navbar = () => {
  const count = useSelector((state) => state.fav.value);
  const cartCount = useSelector((state) => state.cart.value);

  return (
    <div className="Navbar-container">
      <div className="Navbar">
        <a href="/" className="nikes">
          <svg
        ...
        >
          <div className="favDiv">
            ...
            {count.count > 0 ? <p className="favCount">{count.count}</p> : ""}
          </div>
        </a>
        <a href="/cart" className="cart">
          <div className="cartDiv">
            ...
            {cartCount.count > 0 ? (
              <p className="cartCount">{cartCount.count}</p>
            ) : (
              ""
            )}
          </div>
